...
const ApplicationManager = (props) => {
    const {managerRole = 'Менеджер', managerName = 'Екатерина Л.'} = props;
    return (
        <article className={styles.application__manager}>
            ...
            <p className={styles.application__manager_role}>{managerRole}</p>
            <p className={styles.application__manager_name}>{managerName}</p>
        </article>
    );
};
